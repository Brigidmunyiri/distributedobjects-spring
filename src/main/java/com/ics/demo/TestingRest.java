...
//          System.out.println("updated"+updatemovie.toString())
        ...
        //create student
        Student student =new Student(94121,"Brigid");
        feignRestClient.createStudent(student);



        //view student
        //feignRestClient.viewstudent((long)9500);

            //create variable appointment and confirm
//      Appointment newappAppointment=new Appointment(5,1);
        Attachment newattachment = new Attachment(17,27);

        //confirm appointmment
//        newappAppointment=feignRestClient.ConfirmAppointment((long)5,(long)1);
        //create appointment
        //feignRestClient.createAppointment(newappAppointment);
        //feignRestClient.createStudent(student);
        feignRestClient.createAttachment(newattachment);
        feignRestClient.createStudent(student);
